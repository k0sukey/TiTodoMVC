(function(tirequire,__dirname,__filename){module.id=__filename;module.loaded=false;module.filename=__filename;var require=tirequire("node_modules/ti-commonjs/lib/ti-commonjs")(__dirname,module);module.require=require;function S4() {
...
var Alloy = tirequire("alloy"), _ = tirequire("alloy/underscore")._, TAP = Ti.App.Properties;
...
module.loaded=true;})(require,"/alloy/sync","/alloy/sync/properties.js");