(function(tirequire,__dirname,__filename){module.id=__filename;module.loaded=false;module.filename=__filename;var require=tirequire("node_modules/ti-commonjs/lib/ti-commonjs")(__dirname,module);module.require=require;module.exports = function(grunt) {
    var embedOption = grunt.option("embedLanguages"), embedLanguageDest = embedOption ? "min/moment-with-customlangs.js" : "min/moment-with-langs.js", embedLanguageLangs = "lang/*.js";
    embedOption && embedOption.match(/,/) ? embedLanguageLangs = "lang/{" + embedOption + "}.js" : embedOption && (embedLanguageLangs = "lang/" + embedOption + ".js");
    grunt.initConfig({
        ...
        concat: {
            ...
            tests: {
                src: [ "test/browser-prefix.js", "test/moment/*.js", "test/lang/*.js", "test/browser-suffix.js" ],
                dest: "min/tests.js"
            }
        },
        env: {
        ...
        karma: {
            ...
            sauce: {
                ...
                singleRun: true,
                browsers: [ "slChromeWinXp", "slIe9Win7", "slIe8Win7", "slFfLinux", "slSafariOsx" ]
            }
        },
        uglify: {
            target: {
        ...
        jshint: {
            all: [ "Gruntfile.js", "moment.js", "lang/**/*.js", "test/**/*.js", "!test/browser*.js" ],
            options: {
                node: true,
                browser: true,
                boss: false,
    ...
    grunt.registerTask("build:travis", [ "jshint", "test:node", "check-sauce-creds", "test:travis-sauce-browser" ]);
    grunt.registerTask("release", [ "jshint", "nodeunit", "concat", "embedLanguages", "component", "uglify" ]);
};
module.loaded=true;})(require,"/node_modules/moment","/node_modules/moment/Gruntfile.js");