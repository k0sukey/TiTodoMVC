(function(tirequire,__dirname,__filename){module.id=__filename;module.loaded=false;module.filename=__filename;var require=tirequire("node_modules/ti-commonjs/lib/ti-commonjs")(__dirname,module);module.require=require;function getVersion(path, cb) {
    var data = "", req = https.request({
        host: "raw.github.com",
        port: 443,
...
function printDiffs(stableLen, stableGzip, currentLen, currentGzip) {
    var diff = currentLen - stableLen, gzipDiff = currentGzip - stableGzip;
...
module.loaded=true;})(require,"/node_modules/moment/tasks","/node_modules/moment/tasks/size.js");