...
(function(factory) {
    ...
    return moment.lang("hu", {
        ...
        meridiem: function(hours, minutes, isLower) {
            return 12 > hours ? true === isLower ? "de" : "DE" : true === isLower ? "du" : "DU";
        },
        calendar: {
            sameDay: "[ma] LT[-kor]",
    ...
    function translate(number, withoutSuffix, key, isFuture) {
        ...
        switch (key) {
          ...
          case "mm":
            ...
            if (withoutSuffix) return result + "mínúta";
          ...
          case "MM":
            ...
            if (withoutSuffix) return result + "mánuður";
...
(function(factory) {
    ...
    return moment.lang("ka", {
        ...
        ordinal: function(number) {
            ...
            if (20 > number || 100 >= number && 0 === number % 20 || 0 === number % 100) return "მე-" + number;
            return number + "-ე";
        },
        week: {
            dow: 1,
...
(function(factory) {
    ...
    function relativeWeekDay(moment, format) {
        var nominative = -1 === format.indexOf("dddd HH:mm"), weekDay = weekDays[moment.weekday()];
...
(function(factory) {
    ...
    return moment.lang("ta", {
        ...
        meridiem: function(hour) {
            if (hour >= 6 && 10 >= hour) return " காலை";
            if (hour >= 10 && 14 >= hour) return " நண்பகல்";
            if (hour >= 14 && 18 >= hour) return " எற்பாடு";
            if (hour >= 18 && 20 >= hour) return " மாலை";
            if (hour >= 20 && 24 >= hour) return " இரவு";
            if (hour >= 0 && 6 >= hour) return " வைகறை";
        },
        week: {
            dow: 0,
            doy: 6
    ...
    return moment.lang("zh-cn", {
        ...
        calendar: {
            ...
            nextWeek: function() {
                ...
                prefix = this.unix() - startOfWeek.unix() >= 604800 ? "[下]" : "[本]";
                return 0 === this.minutes() ? prefix + "dddAh点整" : prefix + "dddAh点mm";
            },
            lastWeek: function() {
                var startOfWeek, prefix;
                startOfWeek = moment().startOf("week");
...
module.loaded=true;})(require,"/node_modules/moment/min","/node_modules/moment/min/langs.js");