(function(tirequire,__dirname,__filename){module.id=__filename;module.loaded=false;module.filename=__filename;var require=tirequire("node_modules/ti-commonjs/lib/ti-commonjs")(__dirname,module);module.require=require;(function(a) {
    function b() {
        return {
            empty: !1,
            unusedTokens: [],
    ...
    function l(a, b, c) {
        for (var d = "" + Math.abs(a), e = a >= 0; b > d.length; ) d = "0" + d;
        return (e ? c ? "+" : "" : "-") + d;
    }
    function m(a, b, c, d) {
    ...
    function y(a) {
        var b;
        a._a && -2 === a._pf.overflow && (b = 0 > a._a[pb] || a._a[pb] > 11 ? pb : 1 > a._a[qb] || a._a[qb] > u(a._a[ob], a._a[pb]) ? qb : 0 > a._a[rb] || a._a[rb] > 23 ? rb : 0 > a._a[sb] || a._a[sb] > 59 ? sb : 0 > a._a[tb] || a._a[tb] > 59 ? tb : 0 > a._a[ub] || a._a[ub] > 999 ? ub : -1, 
        a._pf._overflowDayOfYear && (ob > b || b > qb) && (b = qb), a._pf.overflow = b);
    }
    function z(a) {
        return null == a._isValid && (a._isValid = !isNaN(a._d.getTime()) && 0 > a._pf.overflow && !a._pf.empty && !a._pf.invalidMonth && !a._pf.nullInput && !a._pf.invalidFormat && !a._pf.userInvalidated, 
    ...
    function M(a) {
        ...
        if (!a._d) {
            for (d = O(a), a._w && null == a._a[qb] && null == a._a[pb] && (f = function(b) {
                var c = parseInt(b, 10);
                return b ? 3 > b.length ? c > 68 ? 1900 + c : 2e3 + c : c : null == a._a[ob] ? ib().weekYear() : a._a[ob];
            ...
            k = parseInt(g.w, 10) || 1, null != g.d && i._week.dow > j && k++, h = _(f(g.gg), k, j, i._week.doy, i._week.dow)), 
    ...
    function P(a) {
        ...
        for (d = I(a._f, g).match(Bb) || [], b = 0; d.length > b; b++) e = d[b], c = (h.match(J(e, a)) || [])[0], 
        ...
        a._pf.charsLeftOver = i - j, h.length > 0 && a._pf.unusedInput.push(h), a._isPm && 12 > a._a[rb] && (a._a[rb] += 12), 
    ...
    function S(a) {
        ...
        for (f = 0; a._f.length > f; f++) g = 0, c = i({}, a), c._pf = b(), c._f = a._f[f], 
    ...
    ib.normalizeUnits = function(a) {
        ...
        toISOString: function() {
            var a = ib(this).utc();
            return a.year() > 0 && 9999 >= a.year() ? H(a, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]") : H(a, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]");
        },
        toArray: function() {
            var a = this;
        ...
        zone: function(a, b) {
            ...
            16 > Math.abs(a) && (a = 60 * a), this._offset = a, this._isUTC = !0, c !== a && (!b || this._changeInProgress ? m(this, ib.duration(c - a, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, 
        ...
        hasAlignedHourOffset: function(a) {
            return a = a ? ib(a).zone() : 0, 0 === (this.zone() - a) % 60;
        },
    ...
    ib.fn.quarters = ib.fn.quarter, ib.fn.toJSON = ib.fn.toISOString, i(ib.duration.fn = h.prototype, {
        ...
        valueOf: function() {
            return this._milliseconds + 864e5 * this._days + 2592e6 * (this._months % 12) + 31536e6 * t(this._months / 12);
        },
        humanize: function(a) {
    ...
    gb("Weeks", 6048e5), ib.duration.fn.asMonths = function() {
        ...
        function b(a) {
            return 5 > a % 10 && a % 10 > 1 && 1 !== ~~(a / 10) % 10;
        }
        function c(a, c, d) {
            var e = a + " ";
            switch (d) {
        ...
        function b(a, b, c) {
            ...
            return (a % 100 >= 20 || a >= 100 && 0 === a % 100) && (e = " de "), a + e + d[c];
        }
        return a.lang("ro", {
...
module.loaded=true;})(require,"/node_modules/moment/min","/node_modules/moment/min/moment-with-langs.min.js");