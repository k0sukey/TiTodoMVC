(function(tirequire,__dirname,__filename){module.id=__filename;module.loaded=false;module.filename=__filename;var require=tirequire("node_modules/ti-commonjs/lib/ti-commonjs")(__dirname,module);module.require=require;(function() {
    function n(n, r, t) {
        t = (t || 0) - 1;
        for (var e = n ? n.length : 0; e > ++t; ) if (n[t] === r) return t;
        return -1;
    }
    function r(n, r) {
        for (var t = n.m, e = r.m, u = -1, o = t.length; o > ++u; ) {
            var i = t[u], f = e[u];
            if (i !== f) {
                if (i > f || "undefined" == typeof i) return 1;
                if (f > i || "undefined" == typeof f) return -1;
            }
        }
        return n.n - r.n;
    }
    ...
    function e(n, r, t) {
        ...
        var e = -1;
        t = t - r || 0;
        for (var u = Array(0 > t ? 0 : t); t > ++e; ) u[e] = n[r + e];
        return u;
    }
    function u(n) {
    ...
    function l(n) {
        function r() {
            ...
            return (i || g) && (y || (y = e(arguments)), i && Rr.apply(y, i), g && c > y.length) ? (u |= 16, 
            l([ t, h ? u : -4 & u, y, null, a, c ])) : (y || (y = arguments), s && (t = n[v]), 
            this instanceof r ? (n = f(t.prototype), y = t.apply(n, y), O(y) ? y : n) : t.apply(n, y));
        }
        var t = n[0], u = n[1], o = n[2], i = n[3], a = n[4], c = n[5], p = 1 & u, s = 2 & u, g = 4 & u, h = 8 & u, v = t;
        return r;
    }
    function c(n, r) {
        for (var t = -1, e = m(), u = n ? n.length : 0, o = []; u > ++t; ) {
            var i = n[t];
            0 > e(r, i) && o.push(i);
        }
        return o;
    ...
    function p(n, r, t, e) {
        e = (e || 0) - 1;
        for (var u = n ? n.length : 0, o = []; u > ++e; ) {
            var i = n[e];
            if (i && "object" == typeof i && "number" == typeof i.length && (Cr(i) || b(i))) {
                r || (i = p(i, r, t));
                var f = -1, a = i.length, l = o.length;
                for (o.length += a; a > ++f; ) o[l++] = i[f];
            } else t || o.push(i);
        }
        return o;
    }
    function s(n, r, t, e) {
        ...
        if (t.push(n), e.push(r), i) {
            ...
            return Nr.call(t, r) ? !(l = --c > -1) && er : void 0;
        });
        return t.pop(), e.pop(), l;
    }
    function g(n, r, t) {
        for (var e = -1, u = m(), o = n ? n.length : 0, i = [], f = t ? [] : i; o > ++e; ) {
    ...
    function v(n, r, t, e, u, o) {
        ...
        return f && !t.length && (r &= -17, t = false), a && !e.length && (r &= -33, e = false), 
        (1 == r || 17 === r ? i : l)([ n, r, t, e, u, o ]);
    }
    function y(n) {
        return Vr[n];
    }
    ...
    function _(n) {
        return "function" == typeof n && Ar.test(n);
    }
    function d(n) {
        return Gr[n];
    }
    function b(n) {
        return n && "object" == typeof n && "number" == typeof n.length && Er.call(n) == fr || false;
    }
    function w(n) {
        if (!n) return n;
        for (var r = 1, t = arguments.length; t > r; r++) {
            var e = arguments[r];
    ...
    function T(n) {
        for (var r = -1, t = Ur(n), e = t.length, u = {}; e > ++r; ) {
            var o = t[r];
            u[n[o]] = o;
        }
        return u;
    ...
    function S(n) {
        return "number" == typeof n || n && "object" == typeof n && Er.call(n) == pr || false;
    }
    function N(n) {
        return "string" == typeof n || n && "object" == typeof n && Er.call(n) == hr || false;
    }
    function R(n) {
        for (var r = -1, t = Ur(n), e = t.length, u = Array(e); e > ++r; ) u[r] = n[t[r]];
        return u;
    }
    function k(n, r) {
        var t = m(), e = n ? n.length : 0, u = false;
        return e && "number" == typeof e ? u = t(n, r) > -1 : Lr(n, function(n) {
            return (u = n === r) && er;
        }), u;
    }
    function B(n, r, t) {
        ...
        r = X(r, t, 3), t = -1;
        var u = n ? n.length : 0;
        if ("number" == typeof u) for (;u > ++t && (e = !!r(n[t], t, n)); ) ; else Lr(n, function(n, t, u) {
            return !(e = !!r(n, t, u)) && er;
        });
        return e;
    }
    ...
    function D(n, r, t) {
        ...
        if (r = r && "undefined" == typeof t ? r : a(r, t, 3), "number" == typeof u) for (;u > ++e && r(n[e], e, n) !== er; ) ; else Lr(n, r);
    }
    function I(n, r) {
        var t = n ? n.length : 0;
        if ("number" == typeof t) for (;t-- && false !== r(n[t], t, n); ) ; else {
    ...
    function M(n, r, t) {
        var e = -1, u = n ? n.length : 0;
        if (r = X(r, t, 3), "number" == typeof u) for (var o = Array(u); u > ++e; ) o[e] = r(n[e], e, n); else o = [], 
        Lr(n, function(n, t, u) {
            o[++e] = r(n, t, u);
        });
        return o;
    ...
    function $(n, r, t) {
        ...
        if (null == r && "number" == typeof i) for (;i > ++o; ) t = n[o], t > u && (u = t); else r = X(r, t, 3), 
        D(n, function(n, t, o) {
    ...
    function W(n, r, t, e) {
        ...
        r = X(r, e, 4);
        var o = -1, i = n.length;
        if ("number" == typeof i) for (u && (t = n[++o]); i > ++o; ) t = r(t, n[o], o, n); else Lr(n, function(n, e, o) {
    ...
    function H(n, r, t) {
        if ("number" != typeof r && null != r) {
            ...
            for (r = X(r, t, 3); i > ++o && r(n[o], o, n); ) u++;
        } else u = null == r || t ? 1 : Mr(0, r);
        return e(n, u);
    }
    function J(n, r, t, e) {
        var u = 0, o = n ? n.length : u;
        for (t = t ? X(t, e, 1) : Y, r = t(r); o > u; ) e = u + o >>> 1, r > t(n[e]) ? u = e + 1 : o = e;
        return u;
    }
    function K(n, r, t, e) {
        return "boolean" != typeof r && null != r && (e = t, t = "function" != typeof r && e && e[r] === n ? null : r, 
        r = false), null != t && (t = X(t, e, 3)), g(n, r, t);
    }
    function L(n, r) {
        return arguments.length > 2 ? v(n, 17, e(arguments, 2), null, r) : v(n, 1, null, null, r);
    }
    function Q(n, r, t) {
        var e, u, o, i, f, a, l, c = 0, p = false, s = true;
        if (!A(n)) throw new TypeError();
        if (r = Mr(0, r) || 0, true === t) var g = true, s = false; else O(t) && (g = t.leading, 
        p = "maxWait" in t && (Mr(r, t.maxWait) || 0), s = "trailing" in t ? t.trailing : s);
        var h = function() {
            var t = r - (nt() - i);
            t > 0 ? a = setTimeout(h, t) : (u && clearTimeout(u), t = l, u = a = l = rr, t && (c = nt(), 
            o = n.apply(f, e), a || u || (e = f = null)));
        }, v = function() {
            a && clearTimeout(a), u = a = l = rr, (s || p !== r) && (c = nt(), o = n.apply(f, e), 
            a || u || (e = f = null));
        };
        return function() {
            ...
            return m && a ? a = clearTimeout(a) : a || r === p || (a = setTimeout(h, r)), t && (m = true, 
            o = n.apply(f, e)), !m || a || u || (e = f = null), o;
        };
    }
    function X(n, r, t) {
        var e = typeof n;
    ...
    !function() {
        ...
        return n && "object" == typeof n && "number" == typeof n.length && Nr.call(n, "callee") && !kr.call(n, "callee") || false;
    });
    var Cr = Fr || function(n) {
        return n && "object" == typeof n && "number" == typeof n.length && Er.call(n) == ar || false;
    }, Pr = function(n) {
        var r, t = [];
    ...
    A(/x/) && (A = function(n) {
        return "function" == typeof n && "[object Function]" == Er.call(n);
    });
    ...
    u.after = function(n, r) {
        ...
        for (var r = arguments.length > 1 ? p(arguments, true, false, 1) : x(n), t = -1, e = r.length; e > ++t; ) {
            var u = r[t];
        ...
        for (var r = -1, t = n ? n.length : 0, e = []; t > ++r; ) {
            var u = n[r];
            u && e.push(u);
        }
        return e;
        ...
        for (var n = [], r = -1, t = arguments.length; t > ++r; ) {
            var e = arguments[r];
            (Cr(e) || b(e)) && n.push(e);
        }
        var u = n[0], o = -1, i = m(), f = u ? u.length : 0, a = [];
        n: for (;f > ++o; ) if (e = u[o], 0 > i(a, e)) {
            for (r = t; --r; ) if (0 > i(n[r], e)) continue n;
            a.push(e);
        }
        return a;
    }, u.invert = T, u.invoke = function(n, r) {
        var t = e(arguments, 2), u = -1, o = "function" == typeof r, i = n ? n.length : 0, f = Array("number" == typeof i ? i : 0);
        return D(n, function(n) {
        ...
        "function" != typeof r && t && t[r] === n && (r = null);
        var o = -1, i = n ? n.length : 0;
        if (null == r && "number" == typeof i) for (;i > ++o; ) t = n[o], u > t && (u = t); else r = X(r, t, 3), 
        D(n, function(n, t, o) {
            t = r(n, t, o), e > t && (e = t, u = n);
        });
        return u;
    }, u.omit = function(n) {
        var r = [];
        ...
        for (var r = c(r, p(arguments, true, false, 1)), t = -1, e = r.length, u = {}; e > ++t; ) {
            var o = r[t];
            u[o] = n[o];
        }
        return u;
        ...
        for (var r = -1, t = Ur(n), e = t.length, u = Array(e); e > ++r; ) {
            var o = t[r];
            u[r] = [ o, n[o] ];
        }
        return u;
        ...
        for (var r = -1, t = p(arguments, true, false, 1), e = t.length, u = {}; e > ++r; ) {
            var o = t[r];
            o in n && (u[o] = n[o]);
        }
        return u;
        ...
        var e = -1;
        r = Mr(0, Or((r - n) / t));
        for (var u = Array(r); r > ++e; ) u[e] = n, n += t;
        return u;
        ...
        var u = -1, o = n ? n.length : 0, i = Array("number" == typeof o ? o : 0);
        ...
        var e = true, u = true;
        if (!A(n)) throw new TypeError();
        return false === t ? e = false : O(t) && (e = "leading" in t ? t.leading : e, u = "trailing" in t ? t.trailing : u), 
        t = {}, t.leading = e, t.maxWait = r, t.trailing = u, Q(n, r, t);
    }, u.times = function(n, r, t) {
        n = (n = +n) > -1 ? n : 0;
        var e = -1, u = Array(n);
        for (r = a(r, t, 1); n > ++e; ) u[e] = r(e);
        return u;
    }, u.toArray = function(n) {
        return Cr(n) ? e(n) : n && "number" == typeof n.length ? M(n) : R(n);
    }, u.union = function() {
        ...
        return true === n || false === n || n && "object" == typeof n && Er.call(n) == lr || false;
    }, u.isDate = function(n) {
        return n && "object" == typeof n && Er.call(n) == cr || false;
        ...
        var e = n ? n.length : 0;
        for ("number" == typeof t && (e = (0 > t ? Mr(0, e + t) : $r(t, e - 1)) + 1); e--; ) if (n[e] === r) return e;
        return -1;
    }, u.mixin = Z, u.noConflict = function() {
        return mr._ = Tr, this;
    }, u.random = function(n, r) {
        return null == n && null == r && (r = 1), n = +n || 0, null == r ? (r = n, n = 0) : r = +r || 0, 
        n + Sr(Wr() * (r - n + 1));
        ...
        var r = n ? n.length : 0;
        return "number" == typeof r ? r : Ur(n).length;
        ...
        n.replace(RegExp((e.escape || or).source + "|" + (e.interpolate || or).source + "|" + (e.evaluate || or).source + "|$", "g"), function(r, e, u, o, i) {
            return a += n.slice(f, i).replace(ir, t), e && (a += "'+_.escape(" + e + ")+'"), 
            o && (a += "';" + o + ";\n__p+='"), u && (a += "'+((__t=(" + u + "))==null?'':__t)+'"), 
            f = i + r.length, r;
        ...
        return n && "number" != typeof n.length && (n = R(n)), null == r || t ? n ? n[0 + Sr(Wr() * (n.length - 1 - 0 + 1))] : rr : (n = C(n), 
        n.length = $r(Mr(0, r), n.length), n);
        ...
        u.prototype[n] = function() {
            var n = this.__wrapped__;
            return r.apply(n, arguments), zr.spliceObjects || 0 !== n.length || delete n[0], 
            this;
        };
    ...
    }), "function" == typeof define && "object" == typeof define.amd && define.amd ? (mr._ = u, 
    define(function() {
        return u;
    })) : _r && dr ? br ? (dr.exports = u)._ = u : _r._ = u : mr._ = u;
}).call(this);
module.loaded=true;})(require,"/node_modules/lodash/dist","/node_modules/lodash/dist/lodash.underscore.min.js");