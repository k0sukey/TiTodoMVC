(function(tirequire,__dirname,__filename){module.id=__filename;module.loaded=false;module.filename=__filename;var require=tirequire("node_modules/ti-commonjs/lib/ti-commonjs")(__dirname,module);module.require=require;function testQuux(o) {
    should.exist(o);
...
describe("require()", function() {
    ...
    it('should have a valid list in "require.paths"', function() {
        ...
        require.paths.should.eql([ "/test/node_modules", "/node_modules" ]);
    });
...
mocha.run();
module.loaded=true;})(require,"/node_modules/ti-commonjs/test/app/lib/test","/node_modules/ti-commonjs/test/app/lib/test/index.js");