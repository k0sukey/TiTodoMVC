(function(tirequire,__dirname,__filename){module.id=__filename;module.loaded=false;module.filename=__filename;var require=tirequire("node_modules/ti-commonjs/lib/ti-commonjs")(__dirname,module);module.require=require;(function(undefined) {
    ...
    function dateFromConfig(config) {
        ...
        if (config._w && null == config._a[DATE] && null == config._a[MONTH]) {
            fixYear = function(val) {
                ...
                return val ? 3 > val.length ? intVal > 68 ? 1900 + intVal : 2e3 + intVal : intVal : null == config._a[YEAR] ? moment().weekYear() : config._a[YEAR];
            };
            w = config._w;
    ...
    var moment, oldGlobalMoment, i, VERSION = "2.6.0", globalScope = "undefined" != typeof global ? global : this, round = Math.round, YEAR = 0, MONTH = 1, DATE = 2, HOUR = 3, MINUTE = 4, SECOND = 5, MILLISECOND = 6, languages = {}, momentProperties = {
    ...
    if (hasModule) module.exports = moment; else if ("function" == typeof define && define.amd) {
...
module.loaded=true;})(require,"/node_modules/moment","/node_modules/moment/moment.js");